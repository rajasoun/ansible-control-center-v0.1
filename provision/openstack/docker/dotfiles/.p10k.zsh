# Generated by Powerlevel10k configuration wizard on 2021-06-08 at 06:43 UTC.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 09387.
# Wizard options: compatible, lean_8colors, unicode, 12h time, 1 line, compact, concise,
